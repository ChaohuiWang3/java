 ...
 * <code>exercise.Input</code> that hides the exceptions that can happen when opening a file.  As with
 * <code>exercise.Input</code> all errors during use of the iterator result in a message output to the
...
{
    /**
     * Construct <code>exercise.FileInput</code> object given a file name.
     */
