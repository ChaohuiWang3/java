...
public class Input implements Closeable, Iterator<String>
{
     ...
     * expected it to be) so that <code>exercise.FileInput</code> can access the variable.  This is
     * necessary because <code>exercise.FileInput</code> needs to capture all exceptions that can happen
    ...
    /**
     * The default constructor of an <code>exercise.Input</code> that assumes <code>System.in</code> is to
    ...
    /**
     * Constructor of an <code>exercise.Input</code> object given an <code>InputStream</code> object.
     */
    ...
    /**
     * A finalizer to ensure all files are closed if an <code>exercise.Input</code> object is garbage
     * collected.
     */
    ...
    {
        System.err.println("exercise.Input has been closed.");
        System.exit(1);
    }
    ...
    {
        System.err.println("exercise.Input did not represent " +
